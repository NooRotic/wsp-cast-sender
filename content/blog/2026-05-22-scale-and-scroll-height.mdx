...
The wrong way was faster to type and looked plausible. Documentation for `transform: scale` does not emphasize the layout-bypass aspect because for most cases that is the feature. You read the spec, you build a slider, you bind a value, you ship. Then you scroll.
